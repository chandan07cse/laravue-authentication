    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Please Confirm Your Email Address</span>
                <table class="main">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        ...
                                        <p>Thank You For Registering In Our Site</p>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <tr>
                                                            <td> <a href="{{url("/register/confirm/{$user->activation_token}")}}" target="_blank">Click Here</a></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
                                                        </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="content-block powered-by">
                                Powered by Laravel 5.6 and Vue JS 2
                            </td>
                        </tr>
                    </table>
                </div>
